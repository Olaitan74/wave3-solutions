...
if 1 <= points <= 50:
    result = "Congratulation! You have won a wooden rabbit."
elif 51 <= points <= 150:
    result = "Oh dear, no price this time."
elif 151 <= points <= 180:
    result = "Congratulation! You have won a wafer-thin mint."
elif 181 <= points <= 200:
    result = "Congratulation! You have won a penguin."
else:
    result = "Oh sorry, input not recognized"
